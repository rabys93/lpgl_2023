        ...
        <form method="post" action="{{route('students.store')}}">
            ...
            <fieldset>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="InputFirstname" class="form-control" placeholder="Votre prénom" name="firstName">
                    @error('first_name')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="InputLastname" class="form-control" placeholder="Votre nom" name="lastName">
                    @error('last_name')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
